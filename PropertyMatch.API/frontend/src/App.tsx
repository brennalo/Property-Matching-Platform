...
// Fetches the Google Maps API key from backend then loads the script ONCE.
// Lives inside QueryClientProvider so useQuery is available.
// Must render before any page that uses Google Maps.
